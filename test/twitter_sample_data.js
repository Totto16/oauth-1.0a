...
describe('Twitter Sample', function () {
    ...
    describe('#getBaseString', function () {
        it('should be equal to Twitter example', function () {
            expect(oauth.getBaseString(request, oauth_data)).to.equal(
    ...
    describe('#getSigningKey', function () {
        it('should be equal to Twitter example', function () {
            expect(oauth.getSigningKey(token.secret)).to.equal(
    ...
    describe('#toHeader', function () {
        it('should be equal to Twitter example', function () {
            expect(oauth.toHeader(oauth.authorize(request, token))).to.have.property(
                'Authorization',
